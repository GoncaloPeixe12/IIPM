    ...
    render(){
        ...
        return(
            <div className={'settingsContainer'}>
                <div className={'settingOpt'}><div className={'settingCategory'}>Stream Quality</div></div>
                <div className={'settingOpt'}><div className={'settingText'}>Recording quality</div>   
                    <select className={'dropdown'} size={'2'} value={this.state.quality}>
                ...
                <div className={'settingOpt'}><div className={'settingText'}>Show current viewers</div><input type={'checkbox'} checked={cViewsCheck} className={'settingBox'} onChange={(e) => this.handleCurrViews()}></input></div>
                <div className={'settingOpt'}><div className={'settingText'}>Show total viewers</div><input type={'checkbox'} checked={tViewsCheck} className={'settingBox'} onChange={(e) => this.handleTotalViews()}></input></div>

                <div className={'settingOpt'}><div className={'settingCategory'}>Security</div></div>
                <div className={'settingOpt'}><div className={'settingText'}>Make stream for friends only</div><input type={'checkbox'} checked={fOnlyCheck} className={'settingBox'} onChange={(e) => this.handleFriendsOnly()}></input></div>
                <div className={'settingOpt'}><div className={'settingText'}>Allow location sharing</div><input type={'checkbox'} checked={lShareCheck} className={'settingBox'} onChange={(e) => this.handleShareLoc()}></input></div>
            </div>
        )
    }
}
